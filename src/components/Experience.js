...
const BetterTimeline = () =>{
  return (
<section class="items-center py-16 lg:h-screen font-poppins">
            ...
            <div class="w-full mx-auto lg:max-w-3xl">
                <div class="relative flex justify-between">
                    ...
                    <div class="hidden w-24 py-3 md:block ">
                        <h2 class="text-base font-medium ">2122-2005</h2>
                        <h2 class="text-xs font-medium ">2122-2005</h2>
                    </div>
...
{/* //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
                <div class="relative flex justify-between">
                    <div class="hidden w-24 py-3 md:block ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2005-2009</h2>
                    </div>
                    <div class="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2005-2009</h2>
                    </div>
                    <div class="flex flex-col items-center w-10 mr-4 md:w-24">
                        <div>
                            <div
                                class="flex items-center justify-center w-10 h-10 border border-red-500 rounded-full dark:border-red-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="w-4 h-4 text-red-500 dark:text-red-400 bi bi-globe" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="w-px h-full bg-red-300"></div>
                    </div>
                    <div class="relative flex-1 mb-16 bg-white rounded shadow md:mb-8 dark:bg-gray-900">
                        <div class="absolute inline-block w-4 overflow-hidden -translate-y-1/2 top-7 -left-4">
                            <div
                                class="h-10 origin-top-right transform -rotate-45 bg-white dark:bg-gray-900 drop-shadow-lg">
                            </div>
                        </div>
                ...
                <div class="relative flex justify-between">
                    <div class="hidden w-24 py-3 md:block ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2009-2014</h2>
                        <h2 class="text-xs font-medium text-gray-700 dark:text-gray-400">2009-2014</h2>
                    </div>
                    <div class="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2009-2014</h2>
                    </div>
                    <div class="flex flex-col items-center w-10 mr-4 md:w-24">
                        <div>
                            <div
                                class="flex items-center justify-center w-10 h-10 border border-red-500 rounded-full dark:border-red-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="w-4 h-4 text-red-500 dark:text-red-400 bi bi-code-slash"
                                    viewBox="0 0 16 16">
                                    <path
                ...
                <div class="relative flex justify-between">
                    <div class="hidden w-24 py-3 md:block ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2014-till</h2>
                    </div>
                    <div class="absolute inline-block w-24 py-3 left-16 -top-12 md:hidden ">
                        <h2 class="text-base font-medium text-gray-700 dark:text-gray-400">2014-till</h2>
                    </div>
                    <div class="flex flex-col items-center w-10 mr-4 md:w-24">
                        <div>
                            <div
                                class="flex items-center justify-center w-10 h-10 border border-red-500 rounded-full dark:border-red-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="w-4 h-4 text-red-500 dark:text-red-400 bi bi-clock" viewBox="0 0 16 16">
                                    <path
                    ...
                    <div class="relative flex-1 bg-white rounded shadow dark:bg-gray-900">
                        <div class="absolute inline-block w-4 overflow-hidden -translate-y-1/2 top-7 -left-4">
                            <div
                                class="h-10 origin-top-right transform -rotate-45 bg-white dark:bg-gray-900 drop-shadow-lg">
                            </div>
                        ...
                        <div class="relative z-20 p-6">
                            <p class="mb-2 text-xl font-bold text-gray-600 dark:text-gray-400">Launch Project</p>
                            <p class="text-gray-700 dark:text-gray-500">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. veniam libero facilis minus
                                reprehenderit.
                            </p>
